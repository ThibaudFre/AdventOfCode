    ...
    fs.readFileSync(path.join(process.cwd(), './years/2022/in/day1.txt'), { encoding: "utf8" })
        ...
        /*test*/.reduce((acc, curr) => {
            ...
            //if curr is an empty string so that mean that we arrive to the end of the last Calories of the last Elf
                ...
                //I want to check if the accumulation of all the calories from the last Elf (acc) is the higher one.
                if (acc > hungrierElf) {
                    //If it is, I save it as the higher calories need in the let "hungrierElf"
                    hungrierElf = acc;
                }
